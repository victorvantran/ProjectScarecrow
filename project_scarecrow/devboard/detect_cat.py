...
DEFAULT_MODEL = 'cat_edgetpu.tflite'
DEFAULT_LABELS = 'cat_labels.txt'
DEFAULT_TOP_K = 3
DEFAULT_THRESHOLD = 0.6
DEFAULT_CAPTURE_MODE = 'camera'

DEFAULT_INPUT_VIDEO_DIR = 'input_videos'
DEFAULT_INPUT_VIDEO_FILE = 'cat_park.mp4'

DEFAULT_OUTPUT_VIDEO_DIR = 'output_videos'
DEFAULT_OUTPUT_VIDEO_FILE = 'output_video_cat.avi'
DEFAULT_OUTPUT_VIDEO_FPS = 24
DEFAULT_OUTPUT_VIDEO_RES = '720p'
DEFAULT_OUTPUT_VIDEO_TIME = 50 # seconds
...
def append_objs_to_img(cv2_im, objs, labels):
    ...
    for obj in objs:
        ...
        print(width, height)
        print(x0, y0, x1, y1)
        if (x0 > 10000 or y0 > 10000 or x1 > 10000 or y1 > 10000):
            continue
